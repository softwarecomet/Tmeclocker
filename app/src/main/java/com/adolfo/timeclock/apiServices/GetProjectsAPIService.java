...
public class GetProjectsAPIService extends AsyncTask<Void, Void, String> {
    ...
    public GetProjectsAPIService(Context mContext, OnResultReceived mListner, boolean flagProgress) {
    ...
    protected String doInBackground(Void... unsued) {
        String response;
        try {
            String url = AppConstants.BaseURL + APIServices.GETPROJECTS;
            Log.e("URL", url);
