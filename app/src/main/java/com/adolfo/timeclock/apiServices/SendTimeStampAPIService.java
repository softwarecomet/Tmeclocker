...
public class SendTimeStampAPIService extends AsyncTask<Void, Void, String> {
    ...
    public SendTimeStampAPIService(Context mContext, OnResultReceived mListner, boolean flagProgress) {
    ...
    protected String doInBackground(Void... unsued) {
        String response;
        try {
            String url = AppConstants.BaseURL + APIServices.SENDTIMESTAMP;
            Log.e("URL", url);
